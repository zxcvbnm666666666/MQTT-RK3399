...
def main():
    ...
    p1 = Process(target=threading_control, args=())
    p2 = Process(target=tk_fun, args=())
...
def threading_control():
    t1 = threading.Thread(target=oil_Pressure_recv_data, args=())
    t2 = threading.Thread(target=flow_data_recv_data, args=())
    t3 = threading.Thread(target=rotate_data_recv_data, args=())
    t4 = threading.Thread(target=angle_lon_lat_recv_data, args=())
    t4.start()
    t3.start()
    t2.start()
    t1.start()
